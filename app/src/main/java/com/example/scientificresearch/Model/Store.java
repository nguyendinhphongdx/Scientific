...
public class Store {
    public static User userCurrent = new User("id_current","đình phong","123","phongnguyendx@gmail.com","0102312",new User.imageClass("name","url"));
    ...
    public static ArrayList<Room> getRoom(){
        ...
        for(int i=0;i<50;i++){
            rooms.add(new Room("_id"+i,"phòng "+i,list));
        }
        return rooms;
    }
